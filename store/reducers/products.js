    ...
    switch(action.type){
        case SET_PRODUCTS:
            return {
                ...
                userProducts:action.products.filter((prod)=>{return prod.ownerId==='u1'})
            }
        case DELETE_PRODUCT:
            return {
                ...state,
        ...
        case UPDATE_PRODUCT:
            ...
            const updatedProduct = new Product(action.pid,state.userProducts[productIndex].ownerId,
                action.productData.title,action.productData.imageUrl,action.productData.description,state.userProducts[productIndex].price)
            ...
            return {
                ...state,userProducts:updatedUserProducts,availableProducts:updatedAvailableProducts
            }
    }
    return state;
}
